...
import "./statusbadge.css"; // Nome correto do arquivo CSS

export default function StatusBadge({ status }) {
  // Trata o status para minúsculas e sem espaços
  const statusFormatado = status ? status.toLowerCase().trim() : "";

  // Mapeia o texto do status para a classe CSS e o ícone correspondente
    ...
    switch (statusFormatado) {
      ...
      case "emandamento":
        return {
          ...
          // SVG com animação de rotação nativa pelo CSS do seu amigo
          svgIcon: (
